...
const VALID_TRANSITIONS: Record<Phase, Phase[]> = {
  ...
  prep: ['test_reflex', 'error', 'landing'],
  test_reflex: ['test_colors', 'error', 'landing'],
  test_colors: ['test_memory', 'error', 'landing'],
  test_memory: ['test_compare', 'error', 'landing'],
  test_compare: ['test_path', 'error', 'landing'],
  test_path: ['review', 'error', 'landing'],
  review: ['device_signals', 'error', 'landing'],
  device_signals: ['readiness', 'error', 'landing'],
  readiness: ['submitting', 'error', 'landing'],
  submitting: ['done', 'error', 'landing'],
