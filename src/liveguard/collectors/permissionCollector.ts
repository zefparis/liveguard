/**
 * LiveGuard — Permission collector
 *
...
import type { LiveGuardPermissions, PermissionStatus } from '../types';
...
export async function collectPermissions(): Promise<LiveGuardPermissions> {
