...
export function computeBehaviorSummary(
  ...
  // It is computed here (liveguard-app) and can diverge from 'behaviorStatus' computed
  // in hybrid-vector-api/liveguardFusionTrigger.ts:computeBehaviorStatus() which uses
